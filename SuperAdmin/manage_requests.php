...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Fetch old status + student info before update
    $old = $pdo->prepare("SELECT r.request_status, u.first_name, u.email,
...
<!-- SIDEBAR -->
<?php $current_page = 'requests'; include 'sidebar.php'; ?>
<!-- MAIN -->
...
function openManage(req) {
    ...
    // Show the stored auto-calculated date as a hint
